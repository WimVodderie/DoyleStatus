...
#
# QueueName: MonzaQA
# TargetName: TestCaseMonzaQA.install
# ProjectRef: xse0600/InstallersDoyle/Gaudi/7515
# ReleaseLogs: u:\pgxbe\logs\20180621-150016-6064-xse0600-InstallersDoyle-Kourou
# ScriptFile: u:\pgxbe\releases\xse0600\InstallersDoyle\Gaudi\7515\Doyle;Q=MonzaQA;T=TestCaseMonzaQA.install;A.sh
...
export XBEHOME="u:\\pgxbe\\releases\\xse0600\\InstallersDoyle\\Gaudi\\7515"
export XBEDOYLESCRIPT="Doyle;Q=MonzaQA;T=TestCaseMonzaQA.install;A.sh"
...
if [ "$(xbe_getlr -t xse0600 InstallersDoyle Gaudi)" != "7515" ]
then
