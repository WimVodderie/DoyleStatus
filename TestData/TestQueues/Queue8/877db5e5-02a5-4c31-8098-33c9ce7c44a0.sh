...
# ProjectRef: xse06/InstallersDoyle/Gangnam/0357
# ReleaseLogs: u:\pgxbe\logs\20180621-110116-3376-xse06-InstallersDoyle-KourouPlus
# ScriptFile: u:\pgxbe\releases\xse06\InstallersDoyle\Gangnam\0357\Doyle;Q=OnlinePX3000;T=TestCaseOnlinePX3000Limited.install;A.sh
...
export XBEHOME="u:\\pgxbe\\releases\\xse06\\InstallersDoyle\\Gangnam\\0357"
...
if [ "$(xbe_getlr -t xse06 InstallersDoyle Gangnam)" != "0357" ]
then
