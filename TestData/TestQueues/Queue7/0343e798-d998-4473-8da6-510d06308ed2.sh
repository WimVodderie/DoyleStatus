...
# TargetName: TestCaseOnline3300.install
...
# ScriptFile: u:\pgxbe\releases\xse0600\InstallersDoyle\Kourou\10936\Doyle;Q=OnlineSimplexMiral;T=TestCaseOnline3300.install;A.sh
...
export XBEDOYLESCRIPT="Doyle;Q=OnlineSimplexMiral;T=TestCaseOnline3300.install;A.sh"
