#!/bin/ksh
#
# QueueName: Doyle-Ariane-6
# TargetName: KourouCastorProtectionTest
# ProjectRef: xse0600/ClustersDoyle/Kourou/1464
# ReleaseLogs: u:\pgxbe\logs\20180621-150016-6064-xse0600-InstallersDoyle-Kourou
# ScriptFile: u:\pgxbe\releases\xse0600\ClustersDoyle\Kourou\1464\Doyle;Q=Doyle-Ariane-6;T=KourouCastorProtectionTest;A.sh
...
export XBEDOYLESCRIPT="Doyle;Q=Doyle-Ariane-6;T=KourouCastorProtectionTest;A.sh"
