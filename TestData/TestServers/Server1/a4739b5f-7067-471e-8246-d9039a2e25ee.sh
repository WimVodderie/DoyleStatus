...
# TargetName: TestCaseOnlinePX3000.install
# ProjectRef: xse06/InstallersDoyle/Gangnam/0356
# ReleaseLogs: u:\pgxbe\logs\20180621-100126-1158-xse06-InstallersDoyle-KourouPlus
# ScriptFile: u:\pgxbe\releases\xse06\InstallersDoyle\Gangnam\0356\Doyle;Q=OnlinePX3000;T=TestCaseOnlinePX3000.install;A.sh
...
export XBEHOME="u:\\pgxbe\\releases\\xse06\\InstallersDoyle\\Gangnam\\0356"
export XBEDOYLESCRIPT="Doyle;Q=OnlinePX3000;T=TestCaseOnlinePX3000.install;A.sh"
...
if [ "$(xbe_getlr -t xse06 InstallersDoyle Gangnam)" != "0356" ]
then
